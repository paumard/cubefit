...
class TestMultiProfile(Test1DModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.gauss3_1=MultiProfile(gauss, 3, 1, None)
        self.gauss4_1=MultiProfile(gauss, 4, 1, None)
        self.gauss5_1=MultiProfile(gauss, 5, 1, None)
        self.gauss3_3=MultiProfile(gauss, 3, 3, None)
        self.gauss3x3_1=MultiProfile((gauss,gauss,gauss), (3,3,3), (1,1,1), None)
        self.gauss3_1_5_1=MultiProfile((gauss, gauss), (3, 5), (1, 1), None)
